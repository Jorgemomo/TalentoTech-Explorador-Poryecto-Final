...
# Semáforo de Vencimiento de Medicamentos
...
El objetivo es reducir el consumo accidental de medicamentos vencidos y mejorar la gestión doméstica de tratamientos.

# Objetivos

- Registrar medicamentos y fechas de vencimiento.
- Mostrar alertas visuales tipo semáforo.
- Proveer una interfaz web simple e intuitiva.
- Permitir trabajo colaborativo mediante GitHub.
